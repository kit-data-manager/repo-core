...
- The allowed size of description content has been changed from 255 to 10240 characters. 

For existing databases, a manual update is required to adapt the column size. 
