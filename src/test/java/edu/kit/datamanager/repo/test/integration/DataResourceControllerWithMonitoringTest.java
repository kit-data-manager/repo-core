...
public class DataResourceControllerWithMonitoringTest {
  ...
  @Before
  public void setUp() {
    DataResource sampleResource;
    DataResource otherResource;
    DataResource revokedResource;
    DataResource fixedResource;
  ...
  public void testGetMetrics() throws Exception {
    ...
    Assert.assertTrue("Metrics should contain registered users", content.contains("monitoringtest_registered_users"));
